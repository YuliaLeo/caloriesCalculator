...
export const dateGroups = [
    {value: 'day', heading: 'День'},
    {value: 'week', heading: 'Неделя'},
    {value: 'month', heading: 'Месяц'},
    {value: 'year', heading: 'Год'},
    {value: 'season', heading: 'Сезон'},
];
    ...
    switch (group) {
        ...
        case 'season':
            ...
            default:
                ...
                throw new Error(`Unknown group: ${never}`);
    }
}
